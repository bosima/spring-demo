package cn.bossma.springdemo.http2.ssl.server.controller;

import cn.bossma.springdemo.http2.ssl.server.error.ArgumentException;
import cn.bossma.springdemo.http2.ssl.server.error.BusinessError;
import cn.bossma.springdemo.http2.ssl.server.model.Product;
import cn.bossma.springdemo.http2.ssl.server.service.ProductService;
import cn.bossma.springdemo.http2.ssl.server.controller.dto.NewProductRequest;
import cn.bossma.springdemo.http2.ssl.server.controller.dto.ProductDto;
